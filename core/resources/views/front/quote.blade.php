  ...
  <div class="quote-area pt-115 pb-115">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <form action="{{route('front.sendquote')}}" enctype="multipart/form-data" method="POST" id="quotesubmit">
            @csrf
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
              <div class="col-lg-12 text-center">
                <button type="button" name="button" onclick="gtag_report_conversion()">{{__('Submit')}}</button>
              </div>
            </div>
          </form>
        </div>
...
function gtag_report_conversion(url) {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-595063489/e87ECKmYtMkCEMHl35sC',
      'event_callback': callback
  });

  document.getElementById("quotesubmit").submit();
