...
@section('content')
		...
		<section class="finlance_about about_v1 bg_image pt-120 pb-120" style="background-image: url('{{asset('assets/front/img/'.$bs->intro_bg)}}'); background-size: cover; @if($bs->home_version == 'parallax') background-attachment: fixed; @endif" id="about_intidar">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>
                                            @if (strlen(convertUtf8($point->short_text)) > 250)
                                                {{substr(convertUtf8($point->short_text), 0, 250)}}<span style="display: none;">{{substr(convertUtf8($point->short_text), 250)}}</span>
                                                <a href="#" class="see-more">...<i class="fas fa-plus"></i></a>
                                            @else
		...
		<section class="finlance_partner partner_v1 pb-125">
			<div class="container">
			<div class="row justify-content-center">
					<div class="col-lg-6">
						<div class="section_title text-center mb-70">
				...
				<div class="partner_slide">
					...
					<div class="single_partner">
						<a href="{{$partner->url}}" target="_blank"><img src="{{asset('assets/front/img/partners/'.$partner->image)}}" class="img-fluid" alt="partenaires intidar système de file d'attente" style="width:320px; height:80px"></a>
                    </div>
                    @endforeach
				</div>
			</div>
